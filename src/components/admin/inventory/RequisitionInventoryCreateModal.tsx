...
export const RequisitionInventoryCreateModal: React.FC<RequisitionInventoryCreateModalProps> = ({
  isOpen,
  ...
  const defaultData: RequisitionInventoryData = {
    name: '',
    description: '',
    quantity: 1,
    asset_owner: '',
...
export default RequisitionInventoryCreateModal;
